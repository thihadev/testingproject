                ...
                <div class="col-md-4">
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            ...
                            <li class="dropdown dropdown-small">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">Logout  </span><b class="caret"></b></a>
                                <ul class="dropdown-menu">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="./"><img src="{{url('frontend/img/logo.png')}}"></a></h1>
                    </div>
                </div>
    ...
    <div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					<li>
						<img src="{{url('frontend/img/h4-slide.png')}}" alt="Slide">
					...
					<li><img src="{{url('frontend/img/h4-slide2.png')}}" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="{{url('frontend/img/h4-slide3.png')}}" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="{{url('frontend/img/h4-slide4.png')}}" alt="Slide">
						<div class="caption-group">
						  <h2 class="caption title">
								Apple <span class="primary">Store <strong>Ipod</strong></span>
							</h2>
